...
//        logger.info("before navigate back to: " + driver.getCurrentUrl());
    }
...
//        logger.info("after navigate back to: " + driver.getCurrentUrl());
    }
...
//        logger.info("before navigate forward to: " + driver.getCurrentUrl());
    }
...
//        logger.info("after navigate forward to: " + driver.getCurrentUrl());
    }
...
//        logger.info("before navigate refresh: " + driver.getPageSource());
    }
...
//        logger.info("after navigate refresh: " + driver.getPageSource());
    }
    ...
    public void afterScript(String script, WebDriver driver) {
        ...
        logger.info("script executed success: " + script);
    }
...
//        logger.info("created name of the screenshot: " + fileName);
